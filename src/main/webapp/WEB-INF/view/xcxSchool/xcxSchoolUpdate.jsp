...
<body>
<form:form modelAttribute="xcxSchool" action="${pageContext.request.contextPath}/school/saveUpdate?id=${xcxSchool.id}"
           class="form-horizontal" enctype="multipart/form-data">
    <div class="control-group">
        <label class="control-label">学校名称：</label>
        <div class="controls">
            <form:input path="school" maxlength="50" />
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <form:input path="area" maxlength="50" />
        </div>
    </div>
