/**
 * Copyright &copy; 2015 <a href="http://www.zjwocai.com">浙江我财</a> All rights reserved.
 */
...
public class Page<T> {
	...
	//manager的Global文件夹 由于要引入ckfinder（ajax工具） 暂时不配置
//	private int pageSize = Integer.valueOf(Global.getConfig("page.pageSize")); // 页面大小，设置为“-1”表示不进行分页（分页无效）
	...
	public String toString() {
		...
		sb.append("页,每页<input type=\"text\" value=\""+pageSize+"\" onkeypress=\"var e=window.event||this;var c=e.keyCode||e.which;if(c==13)");
